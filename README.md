...
<ul>
  ...
  <li><strong>Typing</strong>
    <ul>
      ...
      <li>Smart ENTER — label changes automatically (ENT, DONE, SEND, GO, 🔍)</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li><strong>Design</strong>
    <ul>
      ...
      <li>SRounded letter keys (#606060)</li>
...
<strong>Steps</strong>
1. Clone the repo
bashgit clone https://github.com/dilshan-codes/FlashKey.git
cd FlashKey
2. Open in Android Studio
File → Open → select the FlashKey folder
3. Build and install
Connect your phone via USB, select it in the device dropdown, click the green Run button.


5. Enable the keyboard on your phone
Settings → Additional Settings → Keyboard & Input Method → Manage Keyboards → enable FlashKey → set as default
